...
if(config("usepage_forum")) write_menu("http://forum.globelan.net", $title[page][12]);
...
else
{
    ...
    if(config("usepage_kiosk")) write_menu ("index.php?inc=kiosk", $title[page][15]);
...
#		write_menu("http://crew.globelan.net", "Crewforum");
	    ...
	    write_menu("admin.php", "Zpidey er dumm");
    }
